...
while ($file = @readdir($handle))
{
	if ((filetype('designs/'.$file) == 'dir') && ($file <> '.') && ($file <> '..'))
	{
		...
		wb_draw_table_content('', $a1.wb_htmlentities($file).$b1, '', $a1.wb_htmlentities($design_information->name).$b1, '', $a1.wb_htmlentities($design_information->author).$b1, '', $a1.$design_information->version.$b1, '', $a1.$design_information->license.$b1, '', $a1.$aktionen.$b1);
	}
}
closedir($handle);
