...
if (!defined('WBLEGAL')) die('Kann nicht ohne Personal WebBase ausgef&uuml;hrt werden.');
  ...
  if (db_num($res) > 0)
  {
    db_query("UPDATE `".$mysql_zugangsdaten['praefix']."users` SET `passwort` = MD5(`new_password`), `new_password` = '' WHERE `id` = '".db_escape($id)."'");// TODO: use sha3 hash, salted and peppered
