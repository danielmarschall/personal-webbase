...
$fehler = false;
	...
	{
	  $meldung .= '<font color="#FF0000">Kann modules/moddir.txt nicht finden. Zeigt das FTP-Verzeichnis wirklich auf IronBASE?</font>';
	  $fehler = true;
	}

	if ((!$fehler) && (@ftp_size($conn_id, $konfiguration[$m2]['ftp-verzeichnis'].'design/desdir.txt') == -1))
	{
	  $meldung .= '<font color="#FF0000">Kann design/desdir.txt nicht finden. Zeigt das FTP-Verzeichnis wirklich auf IronBASE?</font>';
	  $fehler = true;
	}
