...
echo '<h1>'.htmlentities($modulueberschrift).'</h1>';
  echo 'Hier k&ouml;nnen Sie Konfigurationen an IronBASE-Modulen manuell vornehmen. Dies wird jedoch nicht empfohlen, da auch Fehlkonfigurationen mit ung&uuml;ltigen Werten angenommen werden.<br><br>';
