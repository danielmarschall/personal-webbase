...
<?php					if ($net2ftp_settings["functionuse_view"]   == "yes") { ?><td onclick="submitBrowseForm('<?php echo $directory_js; ?>', '<?php echo $list_files[$i]["dirfilename_js"]; ?>', 'view', '');"       title="<?php echo __("View the highlighted source code of file %1\$s", $list_files[$i]["dirfilename_html"]);               ?>" style="cursor: pointer; cursor: hand;">         <a href="javascript:void(0);"><?php echo __("View");    ?></a></td><?php } ?>
<?php					if ($net2ftp_settings["functionuse_edit"]   == "yes") { ?><td onclick="submitBrowseForm('<?php echo $directory_js; ?>', '<?php echo $list_files[$i]["dirfilename_js"]; ?>', 'edit', '');"       title="<?php echo __("Edit the source code of file %1\$s", $list_files[$i]["dirfilename_html"]);                           ?>" style="cursor: pointer; cursor: hand;">         <a href="javascript:void(0);"><?php echo __("Edit");    ?></a></td><?php } ?>
<?php					if ($net2ftp_settings["functionuse_update"] == "yes") { ?><td onclick="submitBrowseForm('<?php echo $directory_js; ?>', '<?php echo $list_files[$i]["dirfilename_js"]; ?>', 'updatefile', '');" title="<?php echo __("Upload a new version of the file %1\$s and merge the changes", $list_files[$i]["dirfilename_html"]); ?>" style="cursor: pointer; cursor: hand;">         <a href="javascript:void(0);"><?php echo __("Update");  ?></a></td><?php } ?>
<?php				} else { ?>
