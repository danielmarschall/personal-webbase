...
<?php	  		printActionIcon("save", "document.forms['" . $formname . "'].screen.value=3;document.forms['" . $formname . "'].submit();", ""); ?> &nbsp; 
...
<?php 		}
	/* ----- CodePress ----- */
			elseif ($textareaType == "codepress") { ?>
				<textarea id="codepress" name="text" class="codepress javascript linenumbers-on language-<?php echo $programming_language; ?>" style="width:100%; height:450px;" wrap="off"><?php echo $text; ?></textarea>
<?php 		} ?>
			</div>
		</td>
	</tr>
