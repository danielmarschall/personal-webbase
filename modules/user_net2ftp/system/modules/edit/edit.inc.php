...
// Programming language (for CodePress syntax highlighting)
	...
	if     ($filename_extension == "css")         { $programming_language = "CSS"; }
	elseif ($filename_extension == "java")        { $programming_language = "Java"; }
	elseif ($filename_extension == "js" || $filename_extension == "javascript")  
								    { $programming_language = "JavaScript"; }
	elseif ($filename_extension == "pl" || $filename_extension == "perl" || $filename_extension == "cgi") 
								    { $programming_language = "Perl"; }
	elseif ($filename_extension == "ruby")        { $programming_language = "Ruby"; }
	elseif ($filename_extension == "php")         { $programming_language = "PHP"; }
	elseif ($filename_extension == "txt")         { $programming_language = "Text"; }
	elseif ($filename_extension == "sql")         { $programming_language = "SQL"; }
	else                                          { $programming_language = "Generic"; }
