...
Hier k&ouml;nnen Sie eine Datensicherung durchf&uuml;hren, um beispielsweise auf einen anderen IronBASE-Server umzuziehen.<br><br>
...
Hier k&ouml;nnen Sie eine IronBASE-Datensicherung einf&uuml;gen.<br><br>

Achtung: Wenn die IronBASE-Schnittstelle, mit der Sie die Sicherung durchgef&uuml;hrt haben, mehr Module enthielt als diese IronBASE-Schnittstelle, so werden nur die Datens&auml;tze importiert, zu denen die Module gefunden wurden.<br><br>

Bitte Beachten Sie: Wenn Sie Datens&auml;tze hochladen, die die selbe ID-Nummer enthalten, wird IronBASE die ID-Nummern erh&ouml;hen, sodass das Einf&uuml;gen erfolgreich wird. Duplikate sind somit m&ouml;glich. Maximale Dateigr&ouml;&szlig;e: '.ini_get('post_max_size').'B<br><br>
...
Mit dieser Funktion k&ouml;nnen Sie <i>alle Datens&auml;tze</i> aus Ihrer IronBASE-Datenbank entfernen! Bitte geben Sie das Wort &quot;OK&quot; in das Sicherheitsfeld ein. Dieser Vorgang kann nicht mehr r&uuml;ckg&auml;ngig gemacht werden.<br><br>
