...
if (($aktion == 'new') || ($aktion == 'edit'))
{
  ...
  if ($aktion == 'edit')
  {
    $res = db_query("SELECT * FROM `".$mysql_zugangsdaten['praefix']."phpmyadmin` WHERE `id` = '".db_escape($id)."' AND `user` = '".$benutzer['id']."'");
    if (db_num($res) == 0)
...
<tr>
  <td valign="top">Einzelne Datenbank:<img src="design/spacer.gif" height="1" width="35" alt=""></td>
